...
unsigned long down=0;		  // Place to store read PIR Value
...
void telnetMe(){
  ...
  //  }
		if (lastCmd == "2") {
         darkenHue(10, false);
		 Serial.println("*darken Hue 10");

    }
if (lastCmd == "3") {
          brightenHue(50, true);   Serial.println("brightenHue 50");
        }
    }
	if (lastCmd == "4") {
         darkenHue(50, true);   Serial.println("*darken Hue 50");
        }
    if (lastCmd == "5") {
